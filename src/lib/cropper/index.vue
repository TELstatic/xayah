<template>
    <div class="cropper-wrapper">
        <div class="img-box">
            <img class="cropper-image" :id="imgId" crossorigin="anonymous" ref="cropperImage" alt="">
        </div>
        <div class="right-con">
            <div v-if="preview" class="preview-box" :id="previewId"></div>
            <div class="button-box">
                <slot>
                    <Upload action="" :before-upload="beforeUpload" style="display: inline-block">
                        <Button style="width: 150px;" type="primary">上传图片</Button>
                    </Upload>
                    <!--<Button style="width: 75px;" type="primary" @click="close">选择图片</Button>-->
                </slot>
